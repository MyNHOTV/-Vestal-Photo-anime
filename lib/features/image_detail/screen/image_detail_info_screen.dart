...
class ImageDetailInfoScreen extends StatefulWidget {
  const ImageDetailInfoScreen({super.key});

  @override
  State<ImageDetailInfoScreen> createState() => _ImageDetailInfoScreenState();
}

class _ImageDetailInfoScreenState extends State<ImageDetailInfoScreen> {
